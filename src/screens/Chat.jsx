    ...
    <div>
      <div className=" bg-[khaki] w-full p-6 mb-16 items-center flex">
        <img
          ...
          alt="back btn"
          className="w-8 mr-10 cursor-pointer rounded-xl"
        ...
        <img
          ...
          className="w-12 h-12 mr-3 border-2 border-blue-800 rounded-full "
          alt="img"
        />
      ...
      <div className="bg-gray-100 h-[67vh]">
        {chatList.map((item, index) => (
          ...
          >
            <div className="px-10 py-5 mt-4 border border-black rounded-md shadow-md bg-blue-50 shadow-gray-300">
      ...
      <div className="flex items-center justify-center pt-5">
        <input
          ...
          className="w-10/12 px-6 py-2 text-xl border border-gray-500 rounded-lg"
        />
        <button
          onClick={sendMsg}
          className="w-40 py-2 ml-2 text-xl bg-red-200 rounded-lg text"
        >
          Send
        </button>
      </div>
