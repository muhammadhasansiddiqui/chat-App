  ...
  return (
    <div>
      <div className=" bg-[khaki] w-full p-6 mb-16 items-center flex">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSn4zD3DLKLZRCpd0-1v7EQzRm1hdZJaqgojg&s" alt="back btn" className="w-8 mr-10 rounded-xl cursor-pointer" onClick={()=>navigate('/home')} />
        <img
